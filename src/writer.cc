...
t_type* t_type_of<xemmaix::libxml::t_text_writer>::f_derive(t_object* a_this)
{
...
t_scoped t_type_of<xemmaix::libxml::t_text_writer>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_construct<const std::wstring&, bool>::t_bind<xemmaix::libxml::t_text_writer>::f_do(a_class, a_stack, a_n);
}
